...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="row">
      <nav class="nav flex-column col-2 bg-light bg-dark">
        ...
        <form action="addHospital.php" method="post">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <div class=" col-sm-12">
                <div class="row">
                  <label for="" class="col-form-label mr-3">Hospital:</label>
                  <select class="custom-select col" name="" id="" required>
                    <option selected>Open this select menu</option>
          ...
          <div class="form-group row">
            <label for="xray" class="col-sm-12 col-form-label offset-sm-2">XRAY:</label>
              <div class="col-sm-10  offset-sm-2">
          ...
          <div class="form-group row">
            <label for="BSF" class="col-sm-12 col-form-label offset-sm-2">BSF:</label>
              <div class="col-sm-10 offset-sm-2">
      ...
      <div class="container-fluid bg-dark">
        ...
        <div class="d-flex justify-content-center text-light p-2 mb-5">
